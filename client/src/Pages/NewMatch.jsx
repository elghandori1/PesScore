  ...
  <section className="bg-white/90 backdrop-blur-sm p-3 sm:p-8 rounded-xl shadow-xl w-full max-w-xs sm:max-w-md mx-auto">
    ...
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
      <div className="text-center mb-4 sm:mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-blue-600 mb-1 sm:mb-2 font-almarai">مباراة جديدة</h2>
        <p className="text-gray-600 text-xs sm:text-sm font-almarai">سجل مباراتك في كرة القدم مع  صديقك</p>
      </div>
      ...
      <div className="flex flex-col items-center mb-3 sm:mb-4">
        <div className="text-center">
          ...
          <p className="text-xs sm:text-sm text-gray-500 font-almarai">ID: {friend?.id_account || ''}</p>
        </div>
      </div>
        ...
        <div className="w-full sm:w-1/2">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:pr-3 pointer-events-none">
              <span className="text-gray-500 text-xs sm:text-sm font-almarai">أهداف</span>
            </div>
          </div>
        </div>
