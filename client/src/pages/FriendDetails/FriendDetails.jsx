    ...
    <main className="relative z-10 flex flex-col items-center min-h-screen pt-16 pb-20 px-1 sm:px-4">
      <section className="bg-white/90 backdrop-blur-sm p-3 xs:p-4 sm:p-8 rounded-xl shadow-xl w-full max-w-full xs:max-w-md sm:max-w-2xl mx-auto">
        ...
        <div className="flex justify-between mb-5">
          ...
          {/* Action Button */}
          <Link className="inline-flex items-center justify-center px-3 sm:px-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:from-blue-700 hover:to-blue-600 text-xs sm:text-base font-almarai">
