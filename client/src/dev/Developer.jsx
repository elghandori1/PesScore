...
function Developer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 px-4 py-6" style={{ fontFamily: "'Almarai', sans-serif" }}>
      <div className="text-gray-300 text-sm sm:text-base text-center max-w-md mb-4 bg-gray-600 p-4 rounded-lg" style={{ fontFamily: "'Almarai', sans-serif" }}>
        تم تطوير هذا الموقع بواسطة محمد الغنضوري. إذا واجهت أي مشاكل أو كانت لديك أفكار لإضافات جديدة، لا تتردد في التواصل معي.
      </div>
      <div className="bg-gray-800 rounded-lg shadow-xl p-4 sm:p-8 w-full sm:max-w-md border border-gray-700 relative" style={{ fontFamily: "'Almarai', sans-serif" }}>
        <button
          onClick={() => navigate('/')}
